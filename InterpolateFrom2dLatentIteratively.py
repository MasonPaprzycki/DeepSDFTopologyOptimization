...
from IterativeModel import Model  # import your class version
...
EXPERIMENT_NAME = "IterativeLatent2DRadiusSweep"
...
model = Model(
    ...
    model_name=EXPERIMENT_NAME,  # <-- no underscores to avoid KeyError
    scenes=scenes,
    resume=True,
    latentDim=2
)
